# AGENTS.md for Deckhouse Delivery Kit

This repository contains Hugo-based documentation for the Deckhouse Delivery Kit.
...
- EN: <http://localhost/products/delivery-kit/documentation/>
- RU: <http://ru.localhost/products/delivery-kit/documentation/>
